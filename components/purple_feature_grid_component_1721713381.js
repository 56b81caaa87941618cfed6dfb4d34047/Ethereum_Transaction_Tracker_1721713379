...
Vue.component("purple_feature_grid_component_1721713381", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay ahead of the game by monitoring new Ethereum transactions as they occur. Our app provides instant notifications for the latest activity on the blockchain.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Gain deeper insights into Ethereum transactions with our powerful analytics tools. Analyze transaction patterns, identify trends, and make data-driven decisions.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container"><h4 id="feature-3-title" class="flex-1 font-medium" :class="textSecondaryStyle">Customizable Filtering and Alerts</h4></div>
            </div>
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Tailor the app to your specific needs. Set up custom filters to track transactions based on criteria like wallet addresses, token types, or value ranges. Receive alerts for events that matter most to you.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 font-medium" :class="textSecondaryStyle">Seamless Integration with Ethereum Clients</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our app seamlessly integrates with popular Ethereum clients, ensuring a smooth and efficient experience. Access transaction data directly from your preferred client.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Navigate through the app with ease using our intuitive and user-friendly interface. Quickly access the information you need without any unnecessary complexity.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">Trust that your transaction data is safe with our robust security measures. We prioritize data privacy and provide a reliable service you can depend on.</p></div>
        </div>
    </div>`,
        data() {
            return {
